Feature: Recipe Management
  ...
  Scenario: Add a recipe in system
    ...
    When the aggregate uk.gov.justice.services.example.cakeshop.domain.aggregate.Recipe is created
    And the method addRecipe is called with following json
  """
{
	"argsValues": {
		"uuid": "5c5a1d30-0414-11e7-93ae-92361f002671",
		"string": "cheese cake",
		"boolean": true,
		"list": {
			"ingredients": [{
  ...
  """
{
  ...
  """
    ...
    When the method renameRecipe is called with following json
  """
  {
  "argsValues": {
		"string": "apple pie"
  ...
  """
{
  ...
  """
    ...
    When the method removeRecipe is called with following json
  """
  {
  }
  """
